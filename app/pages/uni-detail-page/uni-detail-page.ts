...
export class UniDetailPage {
  ...
  private results: any;
  private contact: any;
  private UniMapPage:any= UniMapPage;

  constructor(private navCtrl: NavController, private alertCtrl: AlertController, private navParams: NavParams, private geolocationService: GeolocationService) {
